...
(function (blink) {
	...
	var copilotoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	copilotoStyle.prototype = {
		bodyClassName: 'content_type_clase_copiloto',
	...
	copilotoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), copilotoStyle.prototype);

	blink.theme.styles['copiloto'] = copilotoStyle;
